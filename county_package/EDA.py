...
path_to_df = pkg_resources.resource_filename('County-Analysis-Project', '../Data/vcounty.csv')
fips_df = pd.read_csv(path_to_df, dtype={"county_fips": str})


# Tidying portion of clean_data.py
# Read the csv
path_to_final_df = pkg_resources.resource_filename('County-Analysis-Project', "../Data/countyVLivEdu.csv")
